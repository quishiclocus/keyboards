...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x5_2(
        ...
        KC_A,         LCTL_T(KC_S), LALT_T(KC_D), KC_F,            KC_G,           KC_H,          KC_J,         KC_K,     KC_L,   KC_BSPC,
        LSFT_T(KC_Z), KC_X,         KC_C,         LCTL_T(KC_V),    KC_B,           KC_N,          KC_M,         KC_COMMA, KC_DOT, RSFT_T(KC_SLSH),
                                  MO(3), LGUI_T(KC_SPC), LT(1, KC_TAB), LT(2, KC_ENT)
    ),
    ...
    [3] = LAYOUT_split_3x5_2(
        QK_MACRO_0,  KC_NO, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO, KC_NO, KC_NO,
